...
module('Acceptance | changes', function (hooks) {
  ...
  test('When we visit the changes route without query parameters, we see the features and deprecations that occurred since version 3.15', async function (assert) {
    ...
    assert.strictEqual(
      ...
      3,
      'We see 3 new feature that occurred in Ember Data since version 3.15'
    );
    ...
    assert.strictEqual(
      ...
      4,
      'We see 4 deprecations that occurred in Ember Data since version 3.15'
    );
    ...
    assert.strictEqual(
      ...
      29,
      'We see 29 new features that occurred in Ember CLI since version 3.15'
    );
